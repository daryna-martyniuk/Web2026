...
<template>
  <div :class="[
    ...
    <h2 class="text-2xl font-extrabold text-gray-800 mt-2">{{ plan?.name }}</h2>
    ...
    <div class="flex items-baseline gap-1.5 mt-2">
      <span class="text-4xl font-extrabold text-gray-800 tracking-tight">${{ plan?.price?.toFixed(2) }}</span>
    ...
    <div class="mt-4" v-if="plan?.savings">
